...
//		PrintWriter out = new PrintWriter(writer);
		...
		out.println("<h2>Post Test Kr</h2>");
		out.println("<li> 이름 : "+clientName);
		out.println("<li> 주소 : "+clientAddr);

		out.println("<p><p><a href='./jw02/postDataATagServletMapping.html'>뒤로</a>");

		out.println("<p><a href='PostDataATagServletMapping?name=홍길동&addr=서울'>"
						+"자기자신</a>");
